...
export class BillingComponent implements OnInit {
  ...
  doBill() {
    this.receiptNo = `SB${new Date().getDay()}${
      new Date().getMonth() + 1
  ...
  printPdf() {
    ...
    doc.setFontSize(14);
    doc.setFontStyle("bold");
    doc.text(`${localStorage.businessName}`, 36, 14.2);
    doc.setFontSize(10);
    ...
    doc.text("Generated by StockBox", 36, 20);
    doc.setFontSize(9);
    ...
    doc.text(`Owner(${localStorage.businessName}) Authentication...`, 16, 266);
